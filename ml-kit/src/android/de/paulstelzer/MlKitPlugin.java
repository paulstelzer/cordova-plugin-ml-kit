...
public class MlKitPlugin extends CordovaPlugin {
  ...
  private void runTextRecognition(final CallbackContext callbackContext, final String img) {
    ...
    private void runTextRecognitionCloud(final CallbackContext callbackContext, final String img, final String language) {
        Uri imgSource = Uri.parse(img);
        ...
        try {
            ...
            FirebaseVisionCloudTextRecognizerOptions options =
                    new FirebaseVisionCloudTextRecognizerOptions.Builder()
                            .setLanguageHints(Arrays.asList(language))
                            .build();
